...
> **Warning:** Overclocking increases heat output significantly. Only attempt this with **adequate active cooling!!** Just a heatsink alone will **NOT** be sufficient enough to keep things cool and stable. The settings below are tuned for the RaspberryPi5 installed in a Pironman 5 Max case with its tower cooler and dual RGB case fans. If you are using a different case or cooler, start at `arm_freq=2600` and work up gradually while monitoring temperature. **Do not overclock without a fan!!**
